		...
		if(person == "SalesPerson"){
			...
			socket.on("sendMSGToSalesmen", async (data) => {
				...
				if(data.to == me){
					...
					if(sentimentObj){
						//console.log(sentimentObj.sentiment)
						//console.log(chart)
						if(chart){
							if(sentimentObj.sentiment == "neutral"){
								//document.getElementById("chartId")["data-data"]="20, 10, 40, 25, 15"
								chart.data.datasets[0].data = [20, 10, 40, 25, 15]
								chart.update();
							}
							if(sentimentObj.sentiment == "positive"){
								//document.getElementById("chartId")["data-data"]="40, 10, 10, 10, 10"
								chart.data.datasets[0].data = [40, 15, 25, 20, 15]
								chart.update();
							}
							if(sentimentObj.sentiment == "negative"){
								//document.getElementById("chartId")["data-data"]="10, 40, 10, 10, 10"
								chart.data.datasets[0].data = [15, 40, 20, 20, 20]
								chart.update();
							}
						}
					}
			...
			config: {
				iceServers: [
					...
					},
					{
					  ...
					  username: "1583d47344fcb69003300a81",
					  credential: "Zd8vsFZrXbpvoiPe",
					},
					{
                    ...
                    <div className="row mt-3 ">
						{
							...
							<>
								<div className="col-lg-7 col-md-12 col-sm-12">
									...
									{
									/*
									<div className="row pt-4 speech-res">
										<div className="col-lg-1 col-md-1 col-sm-1 soundWave d-flex justify-content-center align-items-center">
											<i className="bi bi-soundwave fs-1 violet"></i>
										</div>
										<div className="col-lg-11 col-md-11 col-sm-11">
											<div className="pb-1">
												<span className="s-title fs-6 text-secondary">Conversation Now</span>
											</div>
											<div>
												<span className="s-text fs-5 fw-bold">Hello! I'm interested in your product, and I have a few questions before making a purchase.</span>
											</div>
										</div>
									</div>
									*/
									...
									<div className="row pt-4">
												...
												<div className="card-body p-4">
													<div className="row chart-res">
														<div className="col-lg-10 col-md-10 col-sm-10 pt-1">
															<span className="sentiment fs-5 fw-bold">Sentiment Score</span>
														</div>
														...
														<div>
															<span className="sentiment-t fs-6 pt-2">See how their Tone in one sheet</span>
														</div>
													</div>
													
													<div className="chart-res d-flex justify-content-center align-items-center pt-4">
														<canvas id="chartId" aria-label="chart" height="294" width="400" data-labels="Positive, Negative, Neutral, Mixed, Ambiguous" data-data="20, 40, 33, 35, 30" data-bg-color="#b597f0" data-point-bg-color="#b597f0" data-border-color="black" data-border-width="1" data-point-radius="2" data-line-width="3" data-responsive="false"></canvas>
													</div>
												</div>
										...
										{
										/*
										<div className="col-lg-6 col-md-12 col-sm-12 pt-res">
											<div className="card">
												<div className="card-body p-4">
													<div className="row chart-res">
														<div className="col-lg-10 col-md-10 col-sm-10 pt-1">
															<span className="sentiment fs-5 fw-bold">Expression Score</span>
														</div>
														<div className="col-lg-2 col-md-2 col-sm-2 d-flex justify-content-center align-items-center">
															<i className="sentiment-i bi bi-info-circle fs-5 violet"></i>
														</div>
									...
									{
									/*
									<div className="row pt-4 pt-res">
										<div className="col-lg-12">
											<div className="card">
												<div className="card-body p-4">
													<div className="row chart-res">
														<div className="col-lg-11 col-md-11 col-sm-11 pt-1">
															<span className="sentiment fs-5 fw-bold">Voice Tone Expression Score</span>
														</div>
													...
													<div className="d-flex justify-content-center align-items-center pt-4">
														<canvas id="voice-tone-chart" width="700" height="300" 
															data-labels="Happiness, Sadness, Anger, Surprise, Neutral" 
															data-data="90, 75, 50, 65, 45" 
															data-bg-colors="#712cf9,#FFA500,#d9dee2,#cc1717,rgba(153, 102, 255, 0.6)" 
															data-responsive="true" 
															data-maintain-aspect-ratio="false" 
															data-begin-at-zero="true" 
															data-max="100">
														</canvas>
													</div>
												</div>
								...
								<div className="col-lg-5 col-md-12 col-sm-12 pt-res">
									{
									/*
										<div className="row">
												<div className="col-lg-12 col-md-12 col-sm-12">
													<div className="card">
														<div className="card-body p-4">
															<div className="row score-res">
																<div className="col-lg-6 col-md-6 col-sm-6 d-flex flex-column align-items-center justify-content-center">
																	
																	<div className="circular-progress" data-start-value="0" data-end-value="80" data-speed="10">
																		<i className="bi bi-mic-fill"></i>
																	</div>
																	<div className="value-container pt-3 fw-bold">0%</div>
																	<div className="score pt-2 fw-bold">Score</div>
																</div>
																<div className="col-lg-6 col-md-6 col-sm-6 d-flex flex-column align-items-center justify-content-center">
																	
																	<div className="circular-progress2" data-start-value="0" data-end-value="60" data-speed="10">
																	<i className="bi bi-emoji-grin-fill"></i>
																	</div>
																	<div className="value-container2 pt-3 fw-bold">0%</div>
																	<div className="score pt-2 fw-bold">Score</div>
																</div>
															</div>
														</div>
											...
											<div className="col-lg-12 col-md-12 col-sm-12">
												<div className="card">
													<div className="card-header p-3 text-center">
														...
														onClick={() => callOpenAI()}>Generate Response</button>
													</div>
